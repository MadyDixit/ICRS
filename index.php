...
<body>
<h1 style="text-align: center; size: 60px"> Indigo Airlines</h1>
...
<div class="wrapper">
	...
	<div class="container" id="c0">
		...
		<div class="story" id="s0">
			<div class="info">
			<a href="snake-highlight\index.html"><h3 style="text-align: center;"><u>Login</u></h3></a>
			</div>
		</div>
	</div>
	<div class="container" id="c1">
		...
		<div class="story" id="s1">
			<div class="info">
				<h3 style="text-align: center;">Direct Booking</h3>
			</div>
		</div>
	</div>
	<div class="container" id="c2">
		...
		<div class="story" id="s2">
			<div class="info">
			<a href="interactive-sign-up-form/index.html"><h3 style="text-align: center;"><u>Sign Up</u></h3></a>
